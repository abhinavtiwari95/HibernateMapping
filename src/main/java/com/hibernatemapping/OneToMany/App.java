package com.hibernatemapping.OneToMany;





import com.hibernatemapping.OneToManyEntity.Laptop;
import com.hibernatemapping.OneToManyEntity.Student;
...
public class App 
{
    public static void main( String[] args )
    {
    	...
    	StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("persistO-M.xml").build();
